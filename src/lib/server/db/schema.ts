export { json } from './schema/common';
...
export { messages, chats, chatParticipants, chatsRelations, chatParticipantsRelations, messagesRelations, messagesReadReceipts, messagesReadReceiptsRelations } from './schema/messages';